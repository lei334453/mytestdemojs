...
class Promise{
  ...
  //可选参数
  onFullfied = typeof onFullfied==='function'?onFullfied:data =>data;
  onRejected = typeof onRejected==='function'?onFullfied:err =>{throw err};
